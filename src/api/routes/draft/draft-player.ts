...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    const player = await playerService.draftPlayer(playerId, price);
    const team = await teamService.draftPlayer(teamId, player, position, price);
...
export { router as draftPlayerRouter };
